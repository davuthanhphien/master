        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    ...
                    <h2><a href="{{route('banner.create')}}">Create</a></h2>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                    <div id="example2_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <table id="table-banner" class="table table-bordered table-hover dataTable" role="grid"
